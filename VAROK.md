...
Worker: `@one_more_person_228` — **ручной Access** (V28): только **Цвирко 100**; single-point live-test выкл. `@arseniyhotko` — Варки сняты (`PARTNER_PROD_V17`). Deploy — **Worker** + **Code.gs**.
...
**Сейчас у `@one_more_person_228`:** только `pt_varka_tsvirko_100` (Цвирко 100).
