/**
 * Trial landing: на карточках — короткие названия;
 * по тапу — полный текст (дословно от владельца).
 */
(function (global) {
  "use strict";
  ...
  var STEPS = {
    ask: {
      body:
        "Мы знаем, как сложно подобрать правильный формат, вкус и жёсткость сушки. Поэтому мы создали сервис, который подстраивается лично под вашего питомца.\n\n" +
    ...
    week: {
      body:
        "Мы дарим тест из одной доставки — это неделя лакомств подобранных идеально под вашего питомца.\n\n" +
        "Питомец дегустирует набор в течение недели"
    },
    feedback: {
      body:
        "Вы делитесь обратной связью: что понравилось, что нет.\n\n" +
        "После этого мы внесём правки и набор получится идеальным"
    }
  };
