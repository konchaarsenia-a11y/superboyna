...
**Градация жевалок (учётные шт склада F, база = ОГРОМНЫЙ = 1):**  
1 ОГР = 2 БОЛ = 4 СРЕД = 8 МАЛ = 16 ОЧ МАЛ. Карта Нарезка→коэф: `CHEW_STOCK_BY_CUT_ROW_`.

| SKU | фракция | учёт |
|---|---|---|
| Бычий корень | ОЧ МАЛ / МАЛ / СРЕД / БОЛ / ОГР | 0.0625 / 0.125 / 0.25 / 0.5 / **1** |
| Трахея | МАЛ / ПЛАСТ / СРЕД / БОЛ / ОГР | 0.125 / 0.25 / 0.25 / 0.5 / **1** (пласт = сред) |
| Становая жила | ПАЛК / СРЕД / БОЛ | 0.125 / 0.25 / 0.5 (огромного нет, палка = мал) |
| Ухо Г | целое / половинка | 0.5 / 0.25 (целое = большой) |
| Аорта | целая / половинка | 0.5 / 0.25 (целая = большой) |
| Перепёлки, колени, хрящ, копыто, шеи, губы, носы | без фракции | 1 шт = 1 шт |
