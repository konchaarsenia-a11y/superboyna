...
**Градация жевалок (учётные шт на складе F, база = БОЛЬШОЙ = 1):**  
1 ОГР = 2 БОЛ = 4 СРЕД = 8 МАЛ = 16 ОЧ МАЛ → коэффициенты ОГР=2, БОЛ=1, СРЕД=0.5, МАЛ=0.25, ОЧ МАЛ=0.125  
(как в формулах Склад для становой: ПАЛК×0.25 + СРЕД×0.5 + БОЛ×1).  
Трахея: ПЛАСТ ≈ СРЕД (0.5). Ухо/аорта: половинка = 0.5.  
`computeWarehouseWeekPlan_` / дефицит: `chewFractionStockFactor_`.
