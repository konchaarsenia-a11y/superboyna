...
**Градация жевалок (учётные «средние» на складе F):** ОГР = 2×БОЛ = 4×СРЕД = 8×МАЛ = 16×ОЧ МАЛ.  
Трахея: ПЛАСТ ≈ СРЕД. Становая: ПАЛК ≈ МАЛ. Ухо/аорта: половинка = 0.5.  
`computeWarehouseWeekPlan_` / дефицит переводит размеры в эти единицы (`chewFractionStockFactor_`).
