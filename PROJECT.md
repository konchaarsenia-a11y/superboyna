...
Блоки Сб/Вс создаются автоматически (`ensureManagerWeekendBlocks_`) — копия названий с Пн + даты от Пт+1/+2.
...
| F | Остаток (ревизия) | закрытие недели |
| G | Флаг «закупить» | лист / TG снабжение |
| K15:K25 | шт-остаток | → в F при закрытии |
