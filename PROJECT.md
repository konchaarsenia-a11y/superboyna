...
**Градация жевалок (учётные шт на складе F, база = ОГРОМНЫЙ = 1):**  
1 ОГР = 2 БОЛ = 4 СРЕД = 8 МАЛ = 16 ОЧ МАЛ → ОГР=1, БОЛ=0.5, СРЕД=0.25, МАЛ=0.125, ОЧ МАЛ=0.0625.  
Трахея: ПЛАСТ ≈ СРЕД (0.25). Ухо/аорта: половинка = 0.25, целое без размера ≈ большой (0.5).  
